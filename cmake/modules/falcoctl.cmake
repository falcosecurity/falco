...
if(ADD_FALCOCTL_DEPENDENCY)
	...
	set(FALCOCTL_VERSION "0.14.1")

	message(STATUS "Building with falcoctl: ${FALCOCTL_VERSION}")

	if(${CMAKE_HOST_SYSTEM_PROCESSOR} STREQUAL "x86_64")
		set(FALCOCTL_SYSTEM_PROC_GO "amd64")
		set(FALCOCTL_HASH "6a5145df3e5767cc7b34bb5ab24e6e092f82de9519c436fe9911838b112deddf")
	else() # aarch64
		set(FALCOCTL_SYSTEM_PROC_GO "arm64")
		set(FALCOCTL_HASH "56061cb665e30bfef6286bd4136230ac85b7930ce2c83dfeeb930b087623b39c")
	endif()
