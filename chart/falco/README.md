...
| terminationGracePeriodSeconds | string | `nil` | Optional duration in seconds the pod needs to terminate gracefully. ref: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#pod-termination |
