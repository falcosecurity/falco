...
The following table lists the main configurable parameters of the falco chart v8.0.6 and their default values. See [values.yaml](./values.yaml) for full list.
