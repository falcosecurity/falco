...
| topologySpreadConstraints | list | `[]` | TopologySpreadConstraints to control how pods are spread across nodes, zones, or regions. ref: https://kubernetes.io/docs/concepts/scheduling-eviction/topology-spread-constraints/ |
