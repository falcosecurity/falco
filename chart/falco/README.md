...
The following table lists the main configurable parameters of the falco chart v6.2.4 and their default values. See [values.yaml](./values.yaml) for full list.
