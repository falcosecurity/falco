...
- Remove default container plugin download as it's bundled in Falco since 0.41.0
...
- Support **falcoctl** tool in the chart:
  - Install the _rulesfile_ artifacts;
  - Follow the _rulesfile_ artifacts in order to have the latest rules once they are released from falcosecurity org;
- Support the **modern-bpf** probe a new driver (experimental)
- Add a new file _BREAKING_CHANGES.md_ to document the breaking changes and how to update the new chart.
...
**Note**
_This release is a complete refactor of the Falco Helm Chart. Thus, it introduces some breaking changes._
_Please, do not reuse values from previous chart installations._
