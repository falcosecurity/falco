...
k8s_audit_filter_check::k8s_audit_filter_check()
{
	m_info = {"ka",
		  ...
		  {{"ka.auditid", "The unique id of the audit event"},
		   ...
		   {"ka.req.sec_ctx.procMount", "When the request object refers to a pod, the procMount type specified by the security context."},
...

	{
		m_aliases = {
			...
			{"ka.req.sec_ctx.procMount", {"/requestObject/spec/securityContext/procMount"_json_pointer}},
